...
export const QueueIndicator = memo(function QueueIndicator({ items, onRemove, onEdit, onSendNow }: Props) {
  ...
  return (
    <div
      ...
      className="mx-auto flex w-[calc(100%-2rem)] max-w-3xl flex-col gap-2 rounded-b-none rounded-t-xl border-x border-b-0 border-t border-phi-border-strong bg-phi-bg-surface py-2 pl-5 pr-3"
    >
